...
#     /DS/RhDec20/AFScale4/
#      December 9, 2020
#   Run Dec 31 for pdf for NS
#
#  #  March 18, 2021 to output PCA & scores
#
#  PCA approach using results from 
#  limma fit (BCaF1) on batch-corrected data
#
#   8/24/21 Show sex on TCvPTC pca plot
...
in3DataPath="/DS/RhDec20/AFScale4/"
...
tl=paste0(Tis," data, TC & PTC samples, PCA-based scoring")
...
f=paste0(outDataPath,"AFScalePCAstuff.RData")
AF_TCvPTC_pca.obj=pca.obj
AF_ScoreAllSamples=MB
AF_Gene.list=Gene.list
save(file = f,AF_TCvPTC_pca.obj,AF_Gene.list,
     AF_ScoreAllSamples)
# ****************************************
